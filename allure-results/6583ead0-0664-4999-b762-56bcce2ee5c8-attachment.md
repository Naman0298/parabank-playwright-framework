...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e27]:
      - generic [ref=e28]:
        - paragraph [ref=e29]: Welcome Myra Schulist
      ...
      - generic [ref=e50]:
        ...
        - table [ref=e52]:
          ...
          - rowgroup [ref=e58]:
            - row "20004 $515.50 $515.50" [ref=e59]:
              - cell "20004" [ref=e60]:
                - link "20004" [ref=e61] [cursor=pointer]:
...
```ts
  ...
  7  | 
  8  | test('Validate Accounts API Response Time', async ({ page, registerPage, user, accountOverviewPage }) => {
  9  | 
  ...
  27 | 
  28 |     console.log('Response Time:', duration, 'ms');
  29 | 
  30 |     expect(response.status()).toBe(200);
  31 | 
> 32 |     expect(duration).toBeLessThan(3000);
     |                      ^ Error: expect(received).toBeLessThan(expected)
  33 | }
  34 | );
```