...
- generic [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e27]:
      - generic [ref=e28]:
        - paragraph [ref=e29]: Welcome Debra Lynch
      ...
      - generic [ref=e50]:
        ...
        - table [ref=e54]:
          - rowgroup [ref=e55]:
            ...
            - row [ref=e105]:
              - cell [ref=e106]
            - 'row "From account #: 21003" [ref=e107]':
              - 'cell "From account #:" [ref=e108]'
              - cell "21003" [ref=e109]:
                - combobox [ref=e110]:
                  - option "21003" [selected]
...
```ts
  ...
  13 | 
  14 |     await ensureAuthenticated(page);
  15 | 
  16 |     await billPayPage.navigate();
  17 | 
> 18 |     const billPayResponse = page.waitForResponse(response => response.url().includes('/billpay'));
     |                                  ^ Error: page.waitForResponse: Test timeout of 60000ms exceeded.
  19 | 
  20 |     await billPayPage.payBill();
  21 | 
  22 |     const response = await billPayResponse;
  23 | 
  24 |     expect(response.status()).toBe(200);
  25 | 
  26 |     const body = await response.json();
  27 | 
  28 |     expect(body.amount).toBe(50);
  29 | 
  30 |     expect(body.accountId).toBeTruthy();
  31 | 
  32 |     expect(body.payeeName).toBeTruthy();
  33 | }
  34 | );
```