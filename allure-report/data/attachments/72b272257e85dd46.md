...
- Location: tests\API\accountDataIntegrity.spec.ts:7:5
  ...
  - generic [ref=e2]:
    ...
    - generic [ref=e27]:
      ...
      - generic [ref=e44]:
        ...
        - table [ref=e48]:
          - rowgroup [ref=e49]:
            - 'row "First Name: Joany" [ref=e50]':
              - cell "First Name:" [ref=e51]
              - cell "Joany" [ref=e52]:
                - textbox [ref=e53]: Joany
              - cell [ref=e54]
            - 'row "Last Name: Lesch" [ref=e55]':
              - cell "Last Name:" [ref=e56]
              - cell "Lesch" [ref=e57]:
                - textbox [ref=e58]: Lesch
              - cell [ref=e59]
            - 'row "Address: 5283 Skiles Flats" [ref=e60]':
              - cell "Address:" [ref=e61]
              - cell "5283 Skiles Flats" [ref=e62]:
                - textbox [ref=e63]: 5283 Skiles Flats
              - cell [ref=e64]
            - 'row "City: East Levi" [ref=e65]':
              - cell "City:" [ref=e66]
              - cell "East Levi" [ref=e67]:
                - textbox [ref=e68]: East Levi
              - cell [ref=e69]
            - 'row "State: Virginia" [ref=e70]':
              - cell "State:" [ref=e71]
              - cell "Virginia" [ref=e72]:
                - textbox [ref=e73]: Virginia
              - cell [ref=e74]
            - 'row "Zip Code: 10112" [ref=e75]':
              - cell "Zip Code:" [ref=e76]
              - cell "10112" [ref=e77]:
                - textbox [ref=e78]: "10112"
              - cell [ref=e79]
            - 'row "Phone #: (736) 727-3656 x94892" [ref=e80]':
              - 'cell "Phone #:" [ref=e81]'
              - cell "(736) 727-3656 x94892" [ref=e82]:
                - textbox [ref=e83]: (736) 727-3656 x94892
              - cell [ref=e84]
            - 'row "SSN: 874522087" [ref=e85]':
              - cell "SSN:" [ref=e86]
              - cell "874522087" [ref=e87]:
                - textbox [ref=e88]: "874522087"
              - cell [ref=e89]
            - row [ref=e90]:
              - cell [ref=e91]
            - 'row "Username: user_1781373364093 This username already exists." [ref=e92]':
              - cell "Username:" [ref=e93]
              - cell "user_1781373364093" [ref=e94]:
                - textbox [ref=e95]: user_1781373364093
...
```ts
  ...
  6  | 
  7  | test('Validate Account Data Integrity', async ({ page, registerPage, user }) => {
  8  | 
...
> 19 |     expect(response.status()).toBe(200);
  ...
  24 | 
  25 |         expect(account.id).toBeGreaterThan(0);
  26 | 
  27 |         expect(account.customerId).toBeGreaterThan(0);
  28 | 
  29 |         expect(typeof account.balance).toBe('number');
  30 | 
  31 |         expect(['CHECKING', 'SAVINGS', 'LOAN'].includes(account.type)).toBeTruthy();
  32 |     }
  33 | }
  34 | );
```