...
- generic [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e27]:
      - generic [ref=e28]:
        - paragraph [ref=e29]: Welcome Eric Will
      ...
      - generic [ref=e50]:
        ...
        - table [ref=e54]:
          - rowgroup [ref=e55]:
            - 'row "Payee Name: Test Payee" [ref=e56]':
              - cell "Payee Name:" [ref=e57]
              - cell "Test Payee" [ref=e58]:
                - textbox [ref=e59]: Test Payee
              - cell [ref=e60]
            ...
            - 'row "Zip Code: 226001" [ref=e76]':
              ...
              - cell [ref=e80]
            - 'row "Phone #: 9999999999" [ref=e81]':
              - 'cell "Phone #:" [ref=e82]'
              - cell "9999999999" [ref=e83]:
                - textbox [ref=e84]: "9999999999"
              - cell [ref=e85]
            - row [ref=e86]:
              - cell [ref=e87]
            ...
            - row [ref=e105]:
              - cell [ref=e106]
            - 'row "From account #: 18228" [ref=e107]':
              - 'cell "From account #:" [ref=e108]'
              - cell "18228" [ref=e109]:
                - combobox [ref=e110]:
                  - option "18228" [selected]
...
```ts
  ...
  4  | 
  5  | test('Validate Bill Payment', async ({ page, registerPage, billPayPage, user }) => {
  6  | 
  ...
  12 | 
  13 |     await billPayPage.navigate();
  14 | 
> 15 |     const billPayResponse = page.waitForResponse(response => response.url().includes('/billpay'));
     |                                  ^ Error: page.waitForResponse: Test timeout of 60000ms exceeded.
  16 | 
  17 |     await billPayPage.payBill();
  18 | 
  19 |     const response = await billPayResponse;
  20 | 
  21 |     expect(response.status()).toBe(200);
  22 | 
  23 |     const body = await response.json();
  24 | 
  25 |     expect(body.amount).toBe(50);
  26 | 
  27 |     expect(body.accountId).toBeTruthy();
  28 | 
  29 |     expect(body.payeeName).toBeTruthy();
  30 | }
  31 | );
```