...
- Location: tests\API\sessionValidation.spec.ts:8:5
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e27]:
      - generic [ref=e28]:
        - paragraph [ref=e29]: Welcome Jules Lesch
        ...
        - list [ref=e31]:
          ...
          - listitem [ref=e46]:
            - link "Log Out" [ref=e47]:
              - /url: logout.htm
      - generic [ref=e48]:
        - heading "Welcome user_1781364409516" [level=1] [ref=e49]
  ...
  - generic [ref=e52]:
    - list [ref=e53]:
      - listitem [ref=e54]:
        ...
        - text: "|"
      - listitem [ref=e56]:
        - link "About Us" [ref=e57]:
          - /url: about.htm
        - text: "|"
      - listitem [ref=e58]:
        - link "Services" [ref=e59]:
          - /url: services.htm
        - text: "|"
      - listitem [ref=e60]:
...
```ts
  ...
  7  | 
  8  | test('Validate Authenticated Session', async ({ page, registerPage }) => {
  9  | 
